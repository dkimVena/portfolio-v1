                    ...
                    <div className="o-grid__col-md-3  o-grid__col-sm-6">
                      <div className="a-header  o-content">
                        <div className="o-content__body">
                          <h4>Linked In</h4>
                          <a
                            href="https://linkedin.com/in/inkoog-kim"
            ...
            <div className="o-content">
              <div className="c-intro">
                <div className="o-content__body">
                  ...
                  <p>• &nbsp;Positive, analytical, self-motivated, and a fast learner</p>
                  <p>
                    • &nbsp;Strong sense of responsibility and problem solving skills with attention
                    to detail
                  </p>
                  <p>• &nbsp;Excellent prioritization skills and time management</p>
                  <p>• &nbsp;Excellent team work skills</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="o-content">
                  <div className="o-grid">
                    <div className="o-grid__col-md-5">
                      <div className="c-work__timeframe">2015 &ndash; 2017</div>
                      <h3 className="c-work__heading">Hyundai U & I</h3>
                      <h4 className="c-work__title">Web developer</h4>
                      <div className="c-work__location" />
                    </div>
                    <div className="description o-grid__col-md-7">
                      <p>
                        Dispatchment in Hyundai Merchant Marine IT Department
                        <br />
                        Development and Maintenance of the Enterprise Legal Management System
                        <br />
              ...
              <div className="a-education-timeline  c-timeline  t-border-color  o-section__full-top-space">
                ...
                <div className="c-timeline__item">
                  ...
                  <div className="o-content">
                    <div className="o-grid">
                      <div className="o-grid__col-md-5">
                        <div className="c-work__timeframe">2017 &ndash; Present</div>
                        <h3 className="c-work__heading">Humber College</h3>
                ...
                <div className="c-timeline__item">
                  ...
                  <div className="o-content">
                    <div className="o-grid">
                      <div className="o-grid__col-md-5">
                        <div className="c-work__timeframe">2008 &ndash; 2015</div>
                        <h3 className="c-work__heading">Handong University</h3>
                        <h4 className="c-work__title">Bachelor of Computer Science</h4>
                        <div className="c-work__location" />
                      </div>
                      <div className="o-grid__col-md-7" />
                    </div>
